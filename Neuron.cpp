...
void Neuron::updateEulerNoisy(double (Neuron::*f)(double), double noise_strength){
    update_count++;
...
void Neuron::updateEulerNoisyIntegrateAll(double (Neuron::*f)(double), double noise_strength){
    update_count++;
